...
def load_sample_data():
    ...
    raise FileNotFoundError(
        "Sample dataset not found in the repository."
    )
...
if source == "Use sample data":
    try:
        ...
        st.error(
            "Sample file was not found. Upload "
            "`certification_review_sample_data.xlsx` either to the repository root "
            "or inside the `sample_data` folder."
        )
else:
